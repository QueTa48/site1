...
<div class="wrap nosubsub woot-options-wrapper">
    ...
    <?php if (time() < 1688076000): ?>
        <div style="position: relative; margin: 6px 0 0 0;">

            <a href="https://codecanyon.pluginus.net/item/woot-woocommerce-products-tables/27928580" target="_blank" class="woot-btn"><span class="icon-upload"></span><?php esc_html_e("Upgrade to Premium with 33% OFF until 30th June 2023") ?></a>
